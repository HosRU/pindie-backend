...
categoriesRouter.put("/categories/:id", findCategoryById, updateCategory, sendUpdateCategory);
categoriesRouter.delete("/categories/:id", findCategoryById, deleteCategories, sendDeleteCategory);
